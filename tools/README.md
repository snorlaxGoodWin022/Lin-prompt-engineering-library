...
```bash
# 列出所有模板
node tools/copy-template.js

# 复制第3个模板到剪贴板
node tools/copy-template.js 3

# 预览模板内容（不复制）
node tools/copy-template.js 3 -p

# 复制指定路径的模板
node tools/copy-template.js prompts/components/react-component.md
```
